...
IMGUI_IMPL_API void     ImGui_ImplAndroid_ProcessQueuedInputEvents();
IMGUI_IMPL_API void     ImGui_ImplAndroid_Shutdown();
IMGUI_IMPL_API void     ImGui_ImplAndroid_NewFrame();
IMGUI_IMPL_API void     ImGui_ImplAndroid_SetInputTransform(int transform, float display_width, float display_height, float input_width, float input_height);
